...
interface ToolkitToolWindow {
    fun addTab(title: String, component: JComponent, activate: Boolean = false, id: String = title, disposer: Disposable? = null): ToolkitToolWindowTab
...
class ToolkitToolWindowManager(private val project: Project) {
    ...
    inner class ManagedToolkitToolWindow(private val type: ToolkitToolWindowType) : ToolkitToolWindow {
        ...
        override fun addTab(title: String, component: JComponent, activate: Boolean, id: String, disposer: Disposable?): ToolkitToolWindowTab {
            ...
            disposer?.let { Disposer.register(content, it) }
